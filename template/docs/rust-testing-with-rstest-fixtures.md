...
setup before a test executes and, sometimes, teardown afterwards. Managing
this setup, together with the teardown logic, within each test function can lead to
